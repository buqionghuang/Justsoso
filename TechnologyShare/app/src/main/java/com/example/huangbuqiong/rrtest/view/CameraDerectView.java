package com.example.huangbuqiong.rrtest.view;
...
/**
 * Created by huangbuqiong on 2017/11/14.
 */

public class CameraDerectView extends View {
    ...
    public CameraDerectView(Context context) {
        this(context, null);
    }

    public CameraDerectView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CameraDerectView(Context context, AttributeSet attrs, int defStyleAttr) {
